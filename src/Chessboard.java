...
public class Chessboard {
    ...
    /**
     * The perspective of the chessboard, indicating the color of the bottom-left
     * cell. Should be 0 for White Perspective (Default) or 9 for Black
     * Perspective.
     */
            ...
            if (row == 0 || row == 9) {
                for (int column = 0; column < 10; column++) {
                    if (column == 0 || column == 9) {
                        ...
                        System.out.printf("%3s", Column.getLetterForColumn(
                            Math.abs(PERSPECTIVE - column)));
                    }
                }
            } else {
                for (int column = 0; column < 10; column++) {
                    if (column == 0 || column == 9) {
                        ...
                        if (boardState[(Math.abs(PERSPECTIVE - (9 - row))) - 1][
                            ...
                            System.out.printf("%3s",
                                boardState[(Math.abs(PERSPECTIVE - (9 - row)))
                                    - 1][(Math.abs(PERSPECTIVE - column)) - 1]);
                        }
                    }
                }
            }
